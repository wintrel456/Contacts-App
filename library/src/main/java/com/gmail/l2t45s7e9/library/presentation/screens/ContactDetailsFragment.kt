...
private const val ALPHA_CONST: Int = 100
private const val BUTTON_STROKE_WIDTH: Int = 2

class ContactDetailsFragment :
    Fragment(R.layout.contact_details_fragment),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBinding.apply {
            ...
            drawable.setStroke(BUTTON_STROKE_WIDTH, color)
    ...
    override fun onCheckedChanged(compoundButton: CompoundButton, isChecked: Boolean) {
        if (isChecked) {
            viewBinding.apply {
                ...
                notificationSwitch.trackTintList = ColorStateList.valueOf(color).withAlpha(ALPHA_CONST)
            }
